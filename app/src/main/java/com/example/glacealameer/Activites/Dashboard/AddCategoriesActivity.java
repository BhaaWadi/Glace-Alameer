    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Category category=new Category(docId,titel,"");
    ...
    private void uploadImageIntoFirebaseStorage(Category category) {
        ...
        storage.getReference().child("Category/"+calendar.getTimeInMillis()).putFile(selectedImageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AddCategoriesActivity.this, "Failed to upload item image", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void addItemToFirestore(Category item) {
        fb.collection("Category").document(item.getDocId()).set(item)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        binding.save.setEnabled(true);
                        binding.mg.setEnabled(true);
                        Toast.makeText(AddCategoriesActivity.this, "Item added successfully", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        binding.save.setEnabled(true);
                        binding.mg.setEnabled(true);
                        Toast.makeText(AddCategoriesActivity.this, "Failed to add new item", Toast.LENGTH_SHORT).show();
                    }
                });
    }
